...
const RaidCard = ({ raid }: RaidCardProps) => {
  ...
  return (
    <div
      className='flex w-1/2 items-center rounded border border-gray-300 bg-white p-4 dark:border-gray-600 dark:bg-gray-800'>
      {/* Raid Icon, scaled from 650 x 200 */ }
      <div className='mr-4 w-40 h-12 bg-gray-300 dark:bg-gray-600'>
        <Image
          src={ iconImage }
          alt={ raid.Name }
          width={ 650 }
