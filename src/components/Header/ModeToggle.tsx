...
export default function ModeToggle({
  ...
  return (
    <label className='inline-flex cursor-pointer items-center'>
      ...
      <div
        className={
          'peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px]' +
          ' after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border' +
          " after:border-gray-300 after:bg-gray-600 after:transition-all after:content-[''] after:peer-checked:bg-white dark:after:bg-white" +
